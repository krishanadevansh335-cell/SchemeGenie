...
const notificationSchema = new mongoose.Schema({
  ...
  type: {
    type: String,
    enum: ['document_rejected', 'application_approved', 'application_rejected', 'new_scheme_match', 'application_submitted', 'application_under_review', 'info', 'success', 'warning', 'error', 'document_uploaded', 'application_deleted'],
    required: true
  },
