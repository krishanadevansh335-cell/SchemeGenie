...
const userDocumentSchema = new mongoose.Schema({
  ...
  category: { type: String, required: true, enum: ['Identity', 'Income', 'Category', 'Banking', 'Address', 'Education', 'Legal', 'Medical', 'Financial', 'Property', 'Business', 'Other'] },
  ...
  // Scheme tracking - which scheme this document was uploaded for
